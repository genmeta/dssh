...
// Keychain certs from h3x test fixtures (relative to this file's crate root)
pub const CA_CERT: &[u8] =
    include_bytes!("../../../../h3x/tests/keychain/localhost/ca.cert");
pub const SERVER_CERT: &[u8] =
    include_bytes!("../../../../h3x/tests/keychain/localhost/server.cert");
pub const SERVER_KEY: &[u8] =
    include_bytes!("../../../../h3x/tests/keychain/localhost/server.key");
